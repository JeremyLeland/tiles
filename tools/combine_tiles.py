...
output_path = '/home/iggames/Downloads/kenney_sketch-desert_combined'
...
y_offset = 0
for img in imgs:
  name = Path( img.filename ).stem
  sx = x_offset * img.width
  sy = y_offset * img.height
  sw = img.width
  sh = img.height

  combined_json[ name ] = [ sx, sy, sw, sh ]
